...
const About = () => (
        <section id="about" class="about">
			<div class="about-txt">
				<h1>about me.</h1>
				<p class="intro">I'm an aspiring and eager web developer based in Perth, Australia. Having just completed a Coding Bootcamp to add full-stack development to my repertoire.</p>
				...
				<br />
				<p class="description">I've held a number of jobs in different countries in my short time; ranging from back of house events and festival work in Perth, consulting and light engineer in Shenzhen, line cook and server in Banff and currently a disabiltiy support worker back in Perth.</p>
				<br />
